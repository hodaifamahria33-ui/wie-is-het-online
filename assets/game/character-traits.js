...
(function () {
  ...
  const AVATAR_CACHE = "yt-likeness-v9-loganpaul";
  ...
  const ROSTER = [
    ...
    { name: "Logan Paul", slug: "loganpaul", seed: "Logan-Paul-Maverick", female: false, bg: "fbbf24,f59e0b,dc2626", hair: "short11", skinColor: "f2d3b1", hairColor: "e5d7a3", eyes: "variant12" },
